...
var light = L.tileLayer('https://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}{r}.png', {
  attribution: '&copy; <a href="https://terminkalender.top">terminkalender.top</a>, Ide <a href="https://demo.terminkalender.top/add/hu">írja</a> be a dátumot.'
}).addTo(map); // EDIT - insert or remove ".addTo(map)" before last semicolon to display by default
controlLayers.addBaseLayer(light, 'Egyszerű Kártya');

/* Stamen colored terrain basemap tiles with labels */
var terrain = L.tileLayer('https://stamen-tiles.a.ssl.fastly.net/terrain/{z}/{x}/{y}.png', {
  attribution: '&copy; <a href="https://terminkalender.top">terminkalender.top</a>, Ide <a href="https://demo.terminkalender.top/add/hu">írja</a> be a dátumot.'
}); // EDIT - insert or remove ".addTo(map)" before last semicolon to display by default
controlLayers.addBaseLayer(terrain, 'Kiterjesztett Térkép');
...
$.get('/assets/data/demotermine_geo.csv', function(csvString) {
  ...
  for (var i in data) {
    ...
    if (row.livestream) {
      var description = "Város: " + row.stadt + "<br/>Dátum: " + row.datum + "<br/>Idő: " + row.uhrzeit + "<br/>Találkozási hely: " + row.treffpunkt + "<br/>A tiltakozás formája: " + row.protestform + "<br/><a href='" + row.livestream + "'>Adás</>"
    } else {
